            ...
            > 
                ...
                >
                    ...
                    <div className="bg-neutral-700 p-6 pb-20 sm:rounded-2xl overflow-y-auto max-sm:rounded-tl-2xl">
                        {children}
                        <div className="content-fade w-full h-12 absolute left-0 sm:rounded-b-2xl bottom-0 bg-gradient-to-b transparent to-80% to-neutral-700 z-[2] pointer-events-none" />
                    </div>
                </motion.div>
            </motion.div>
        </AnimatePresence>
