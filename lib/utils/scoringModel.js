...
export function advancedScoring(qualifyingPos, racePos) {
    ...
    if (isFrontOfBack) {
        if (positionsGained >= 10 && positionsGained <= 12) {
            driverPoints += 2;
            bonusTitle = "Front Overtake Artist Bonus +2";
        } else if (positionsGained >= 13 && positionsGained <= 14) {
            driverPoints += 3;
            bonusTitle = "Front Grid Charger Bonus +3";
        } else if (positionsGained >= 15) {
            driverPoints += 4;
            bonusTitle = "Front Midfield Mauler Bonus +4";
        }
    } else if (isRearOfBack) {
        if (positionsGained >= 10 && positionsGained <= 14) {
            driverPoints += 1;
            bonusTitle = "Back Apex Assassin Bonus +1";
        } else if (positionsGained >= 15 && positionsGained <= 18) {
            driverPoints += 2;
            bonusTitle = "Back Track Titan Bonus +2";
        } else if (positionsGained >= 19) {
            driverPoints += 3;
            bonusTitle = "Back Zero to Hero Bonus +3";
        }
    }
