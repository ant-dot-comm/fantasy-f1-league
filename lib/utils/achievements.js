...
// Map bonusTitle from scoringModel to { achievementId, cardType }
const BONUS_TITLE_TO_CARD = {
  "Big Overtake Artist Bonus +2": { achievementId: ACHIEVEMENT_IDS.BIG_OVERTAKE_ARTIST, cardType: CARD_TYPES.BIG_OVERTAKE_ARTIST },
  "Little Overtake Artist Bonus +1": { achievementId: ACHIEVEMENT_IDS.LITTLE_OVERTAKE_ARTIST, cardType: CARD_TYPES.LITTLE_OVERTAKE_ARTIST },
  "Big Track Titan Bonus +3": { achievementId: ACHIEVEMENT_IDS.BIG_TRACK_TITAN, cardType: CARD_TYPES.BIG_TRACK_TITAN },
  "Little Track Titan Bonus +2": { achievementId: ACHIEVEMENT_IDS.LITTLE_TRACK_TITAN, cardType: CARD_TYPES.LITTLE_TRACK_TITAN },
  "Big Zero to Hero Bonus +4": { achievementId: ACHIEVEMENT_IDS.BIG_ZERO_TO_HERO, cardType: CARD_TYPES.BIG_ZERO_TO_HERO },
  "Little Zero to Hero Bonus +2": { achievementId: ACHIEVEMENT_IDS.LITTLE_ZERO_TO_HERO, cardType: CARD_TYPES.LITTLE_ZERO_TO_HERO },
};
